...
class vvas_xfacedetectrecog:public vvas_xdpumodel
{
  int log_level = 0;
  std::unique_ptr < vitis::ai::FaceDetect > model_fd;
  std::unique_ptr < vitis::ai::FaceFeature > model_fr;
...
public:
  vvas_xfacedetectrecog (vvas_xkpriv * kpriv, const std::string & model_name,
